...
-- REFERENCES es necesario para que las migraciones puedan crear claves foraneas
-- hacia tablas que pertenecen a otro rol (por ejemplo incidents o users).
...
GRANT SELECT, INSERT, UPDATE, DELETE, REFERENCES ON TABLES TO campus_app;
